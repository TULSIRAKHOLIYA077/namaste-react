    ...
    <div className="flex justify-between bg-white shadow-lg">
      ...
      <div className="flex items-center">
        <ul className="flex p-4 m-4">
          <li className="px-4 text-lg font-semibold">Online Status : {onlineStatus ? "✅" : "🔴"}</li>
          ...
          <button className="login px-4 text-lg bg-yellow-300 rounded-md font-semibold" 
            onClick={()=>{
              btnNameReact === "Login"
          ...
          <li className="px-4 font-semibold text-lg">{loggedInUser}</li>
        </ul>
      </div>
    </div>
  )
